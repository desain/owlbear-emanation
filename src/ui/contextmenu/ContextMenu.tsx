        ...
        <>
            ...
            <Stack direction="row" justifyContent="center">
                <Button
                    ...
                    onClick={() => createAurasWithDefaults(selectedItems.filter(isImage), playerMetadata)}
                    sx={{ borderTopRightRadius: 0, borderBottomRightRadius: 0, borderRightColor: 'gray' }}
                >
                    New
                </Button>
                <Button
                    ...
                    sx={{ borderTopLeftRadius: 0, borderBottomLeftRadius: 0, borderLeftWidth: 0 }}
                >
                    Delete All
                </Button>
            </Stack>
